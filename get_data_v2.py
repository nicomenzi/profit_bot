...
async def get_profit(address, contract_address):
    ...
    #        value = int(tx_es["value"]) / 10 ** 18
    #        buyprice.append(value)
    #        profit -= (int(tx_es["value"]) / 10 ** 18) / tx["quantity"]
    #        break
    ...
    print("Count buy:", count_buy)
    print("Count sell:", count_sell)
    print("Count mint:", count_mint)
    print("Profit:", profit)
...
#get_profit("0xefb3bB27B6ABa462185cBFe1F50E395e408e50b0", "0xdb9d073439e5064312c60de43083071835d64998")
#call get_profit with your address and the contract address of the collection you want to che

#await get_profit("0xFE59F409d7A05f8e24aa90626186Cc820c8e3005","0xd04FF5E94340A2e1d913c3728a12B210C5D5Bb2D")
...
#    # profit = await get_profit("0xFE59F409d7A05f8e24aa90626186Cc820c8e3005","0xd04FF5E94340A2e1d913c3728a12B210C5D5Bb2D")
#    profit = await get_collection_name("0xd04FF5E94340A2e1d913c3728a12B210C5D5Bb2D")
#    print(profit)
#
#
#asyncio.run(my_function())

#get_collection("0xd04FF5E94340A2e1d913c3728a12B210C5D5Bb2D")